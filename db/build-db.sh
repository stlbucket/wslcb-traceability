...
psql -U postgres -h 0.0.0.0 -d lcb -f scripts/1000-tenants.sql
psql -U postgres -h 0.0.0.0 -d lcb -f scripts/1100-address-book.sql
psql -U postgres -h 0.0.0.0 -d lcb -f scripts/1500-applications.sql
...
pg_dump -U postgres -h 0.0.0.0 lcb > lcb_setup.sql