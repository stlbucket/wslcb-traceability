...
----------
----------  BEGIN FUNCTION POLICY: lcb_fn.current_lcb_license_holder_id ()
----------  POLICY NAME:  app_user
----------
...
----------  REMOVE EXISTING FUNCTION GRANTS
  ...
  revoke all privileges 
  on function lcb_fn.current_lcb_license_holder_id () 
  from public;
...
----------  END FUNCTION POLICY: lcb_fn.current_lcb_license_holder_id ()
--==
